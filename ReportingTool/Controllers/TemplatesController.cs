...
namespace ReportingTool.Controllers
{
    public class TemplatesController : Controller
    {
        ...
        {
            var fields = _db.Fields.AsNoTracking().Select(field => new FieldModel { fieldID = field.Id, fieldName = field.Name, fieldType = field.FieldType.Type, isSelected = true }).ToList();
